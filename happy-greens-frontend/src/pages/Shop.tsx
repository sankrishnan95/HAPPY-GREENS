...
const Shop = () => {
    ...
    // Use semantically re-ranked results when there's an active search query (capped to top 50 for performance)
    const displayProducts = q ? searchedProducts.slice(0, 50) : products;
